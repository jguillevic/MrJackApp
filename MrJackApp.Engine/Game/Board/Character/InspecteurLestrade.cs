...
{
    public sealed class InspecteurLestrade : Character
    {
        public override int Id { get; protected set; } = 3;
        public override string Name { get; protected set; } = "Inspecteur Lestrade";
        public override int MinMove { get; protected set; } = 1;
        public override int MaxMove { get; protected set; } = 3;

        public InspecteurLestrade() : base() { }
        ...
        {
            return CharacterKind.InspecteurLestrade;
        }
    }
}
